...
export const teachers = [
  { id: "t1", name: "Ing. Ricardo Ponce", area: "Gestión Empresarial", courses: 2, status: "Activo" },
  ...
  { id: "t4", name: "Arq. Lucía Ortega", area: "Sector Inmobiliario", courses: 1, status: "Inactivo" },
];
...
const questionBank: Omit<ExamQuestion, "id">[] = [
  ...
  },
  {
    ...
    type: "single",
    options: ["Productividad", "Rotación de personal", "Cuota de mercado", "Índice de clima laboral"],
    correct: [0],
    score: 5,
  },
];
...
export const enrollmentsAdmin = [
  { id: "i1", student: "Andrea Pérez", course: "Gestor Empresarial", date: "02/07/2026", status: "Activa" },
  { id: "i2", student: "Juan Gómez", course: "Agente Inmobiliario", date: "08/07/2026", status: "Activa" },
  { id: "i3", student: "María Andrade", course: "Administración de Empresas", date: "11/07/2026", status: "Finalizada" },
  { id: "i4", student: "Diego Salazar", course: "Visitador Médico", date: "21/07/2026", status: "Pendiente de pago" },
];
