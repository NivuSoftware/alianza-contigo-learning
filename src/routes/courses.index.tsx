...
export const Route = createFileRoute("/courses/")({
  head: () => ({
    meta: [
      { title: "Catálogo de cursos — Alianza Contigo" },
      {
        name: "description",
        content:
          "Explora los programas de educación continua de Alianza Contigo: gestión empresarial, administración, sector inmobiliario, visita médica y calificación artesanal.",
      },
      { property: "og:title", content: "Catálogo de cursos — Alianza Contigo" },
      {
        property: "og:description",
        content: "Programas con aval institucional, 100% en línea y con certificado de aprobación.",
      },
    ],
  }),
...
function CoursesPage() {
  ...
  const list = courses.filter((c) => {
    ...
    const matchFilter =
      filter === "Todos" || c.endorsements.some((e) => e === filter || (filter === "MIPRO" && e === "MIPRO"));
