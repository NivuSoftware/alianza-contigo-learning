...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Alianza Contigo — Educación Continua con aval institucional" },
      {
        name: "description",
        content:
          "Programas de educación continua con aval SENESCYT y Ministerio del Trabajo. Aprende, crece y trasciende con Alianza Contigo.",
      },
      { property: "og:title", content: "Alianza Contigo — Educación Continua" },
      {
        property: "og:description",
        content:
          "Impulsa tu futuro profesional con programas certificados y aula virtual. Aprende a tu ritmo.",
      },
    ],
  }),
  component: Landing,
          ...
          <div className="animate-fade-in">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Button asChild variant="outline" size="lg">
                <Link to="/certificaciones">Conoce nuestras certificaciones</Link>
              </Button>
            </div>
